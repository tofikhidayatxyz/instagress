...
<title>Instagress / Blog / Great news friends!</title>


<meta name="description" content="We are pleased to inform you that now all new users get 3 days for FREE! "/>
...
<body>
	<header>
		...
		<div class="container navbar-main">
			...
			<a href="great-news-friends.html#" class="btn-navbar-menu" data-ui-menu-toggle="navbar-menu"></a>
			<a href="great-news-friends.html#" class="btn-navbar-menu-login" data-ui-menu-toggle="navbar-menu-login"></a>
		...
		<li class="">
			<a href="great-news-friends.html#" data-popup-open="#popup-support">Support</a>
			
		</li>
	
	<li class="toggle-more">
		<a href="great-news-friends.html#" class="btn-navbar-menu-more"
		...
		<li class="">
			...
			<div class="navbar-mobile-menu" data-ui="navbar-menu-login">
					...
					<ul>
	<li><a href="great-news-friends.html#" data-popup-open="#popup-account-login">Log in</a></li>
	<li class="visible-xs visible-sm">
		<a href="great-news-friends.html#" data-popup-open="#popup-account-signup">Sign up</a>
	</li>
...
<section class="page blog">
	...
	<div class="col-sm-10 col-md-11 pl0">
		<div class="blog-post">
				...
				<p><img src="../static/img-blog/e4uspt.jpg" class="blog-img"/></p>
			

			
				<div class="blog-tags">
					
						<a href="https://instagressalternative.com/blog/tags/free%20time">#free time</a>
	...
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-alert"></a>
	<div class="text"></div>
</div>

	<div id="popup-support" class="popup">
	<h3>Support</h3>
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-support"></a>
	...
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-login"></a>
	...
	<form action="/auth/login"
		...
		<div>
			Unable to sign in?
			<a href="great-news-friends.html#" class="link-ajax"
	...
	<h3>Sign in Help</h3>
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-login-help"></a>
	<div class="mb20">
		<p>
	...
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-reauth"></a>
	<div class="alerts">
		<div class="alert alert-danger alert-error"></div>
		<div class="alert alert-success"></div>
	</div>
	<form action="/auth/login?mode=reauth&next=/blog/great-news-friends"
		...
		<div>
			<a href="great-news-friends.html#" class="link-ajax" data-popup-open="#popup-login-help">Sign in help</a>
		</div>
	</form>
</div>
	...
	<h3>Sign up</h3>
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-account-signup"></a>
...
<div class="dividing-line dividing-line-popup">
	...
	<h3>Log in</h3>
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-account-login"></a>
	<div class="alerts">
		<div class="alert alert-danger alert-error"></div>
		<div class="alert alert-success"></div>
	</div>
...
<div class="dividing-line dividing-line-popup">
	...
	<span>or</span>
		...
		<div class="mb10">
			<a href="great-news-friends.html#" class="link-ajax" data-popup-open="#popup-account-password-reset">Password reset</a>
		</div>
		<div>
	...
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-account-password-reset"></a>
	<div class="color-gray mb20">
	...
	<a href="great-news-friends.html#" class="btn-close-x" data-popup-close="#popup-account-required"></a>
	<p>
