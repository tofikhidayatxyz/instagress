...
<title>Instagress / Blog / Follow &amp; Unfollow at the same time</title>


<meta name="description" content="With our new feature, Follow &amp; Unfollow at the same time, your Activity can automatically switch between following and unfollowing."/>
...
<body>
	<header>
		...
		<div class="container navbar-main">
			...
			<a href="follow-and-unfollow.html#" class="btn-navbar-menu" data-ui-menu-toggle="navbar-menu"></a>
			<a href="follow-and-unfollow.html#" class="btn-navbar-menu-login" data-ui-menu-toggle="navbar-menu-login"></a>
		...
		<li class="">
			<a href="follow-and-unfollow.html#" data-popup-open="#popup-support">Support</a>
			
		</li>
	
	<li class="toggle-more">
		<a href="follow-and-unfollow.html#" class="btn-navbar-menu-more"
		...
		<li class="">
			...
			<div class="navbar-mobile-menu" data-ui="navbar-menu-login">
					...
					<ul>
	<li><a href="follow-and-unfollow.html#" data-popup-open="#popup-account-login">Log in</a></li>
	<li class="visible-xs visible-sm">
		<a href="follow-and-unfollow.html#" data-popup-open="#popup-account-signup">Sign up</a>
	</li>
...
<section class="page blog">
	<div class="container">
		<h1 class="title-big">
			Follow &amp; Unfollow at the same time
	...
	<div class="col-sm-10 col-md-11 pl0">
		<div class="blog-post">
				...
				<p><img src="../static/img-blog/follow-and-unfollow.png" class="blog-img"/></p>
...
<p>
Make sure you have enabled both the Follow and Unfollow actions in your Activity. <b>It’s also very important to choose “Unfollow source: Instagress” for normal (not reverse) unfollow order and better results.</b> Then find and adjust your Follow & Unfollow cycles settings in appropriate categories. You can set the number of users you’d like Instagress to follow for you before switching to unfollowing. Your Activity will continue to switch back and forth between Follow and Unfollow cycles infinitely or until your Follow/Unfollow auto-stop counter is hit.
</p>
<p><strong>Recommended cycles</strong></p>
<p>
We recommend you to set not less than 500 for each cycle, what means that you will unfollow users after one day, but you can find your own cycle amounts that better suit your needs. For example, if you run your Activity on Normal speed (~20 Follow actions per hour) and you want to unfollow users after 3 days then you need to set your Follow cycle to 1440 (20 * 24 * 3).
</p>
<p><strong>What happens when I hit a limit?</strong></p>
<p>
...
We can’t wait to see how Follow & Unfollow cycles are working out for you. Please give us your feedback in the comments below.
				...
				<div class="blog-tags">
						...
						<a href="https://instagressalternative.com/blog/tags/follow">#follow</a>
					
						<a href="https://instagressalternative.com/blog/tags/unfollow">#unfollow</a>
	...
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-alert"></a>
	<div class="text"></div>
</div>

	<div id="popup-support" class="popup">
	<h3>Support</h3>
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-support"></a>
	...
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-login"></a>
	...
	<form action="/auth/login"
		...
		<div>
			Unable to sign in?
			<a href="follow-and-unfollow.html#" class="link-ajax"
	...
	<h3>Sign in Help</h3>
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-login-help"></a>
	<div class="mb20">
		<p>
	...
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-reauth"></a>
	<div class="alerts">
		<div class="alert alert-danger alert-error"></div>
		<div class="alert alert-success"></div>
	</div>
	<form action="/auth/login?mode=reauth&next=/blog/follow-and-unfollow"
		...
		<div>
			<a href="follow-and-unfollow.html#" class="link-ajax" data-popup-open="#popup-login-help">Sign in help</a>
		</div>
	</form>
</div>
	...
	<h3>Sign up</h3>
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-account-signup"></a>
...
<div class="dividing-line dividing-line-popup">
	...
	<h3>Log in</h3>
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-account-login"></a>
	<div class="alerts">
		<div class="alert alert-danger alert-error"></div>
		<div class="alert alert-success"></div>
	</div>
...
<div class="dividing-line dividing-line-popup">
	...
	<span>or</span>
		...
		<div class="mb10">
			<a href="follow-and-unfollow.html#" class="link-ajax" data-popup-open="#popup-account-password-reset">Password reset</a>
		</div>
		<div>
	...
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-account-password-reset"></a>
	<div class="color-gray mb20">
	...
	<a href="follow-and-unfollow.html#" class="btn-close-x" data-popup-close="#popup-account-required"></a>
	<p>
