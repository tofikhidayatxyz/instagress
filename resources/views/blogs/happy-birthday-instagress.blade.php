...
<title>Instagress / Blog / Happy Birthday Instagress</title>


<meta name="description" content="Our first beta version was launched publicly a year ago today. We’d like to thank you all for your kind and supportive words during all this time."/>
...
<body>
	<header>
		...
		<div class="container navbar-main">
			...
			<a href="happy-birthday-instagress.html#" class="btn-navbar-menu" data-ui-menu-toggle="navbar-menu"></a>
			<a href="happy-birthday-instagress.html#" class="btn-navbar-menu-login" data-ui-menu-toggle="navbar-menu-login"></a>
		...
		<li class="">
			<a href="happy-birthday-instagress.html#" data-popup-open="#popup-support">Support</a>
			
		</li>
	
	<li class="toggle-more">
		<a href="happy-birthday-instagress.html#" class="btn-navbar-menu-more"
		...
		<li class="">
			...
			<div class="navbar-mobile-menu" data-ui="navbar-menu-login">
					...
					<ul>
	<li><a href="happy-birthday-instagress.html#" data-popup-open="#popup-account-login">Log in</a></li>
	<li class="visible-xs visible-sm">
		<a href="happy-birthday-instagress.html#" data-popup-open="#popup-account-signup">Sign up</a>
	</li>
...
<section class="page blog">
	...
	<div class="col-sm-10 col-md-11 pl0">
		<div class="blog-post">
				...
				<p><img src="../static/img-blog/eayru4.png" class="blog-img"/></p>
			

			
				<div class="blog-tags">
					
						<a href="/blog/tags/birthday">#birthday</a>
					
						<a href="/blog/tags/website">#website</a>
					
						<a href="/blog/tags/features">#features</a>
					
						<a href="https://instagressalternative.com/blog/tags/multiple%20accounts">#multiple accounts</a>
	...
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-alert"></a>
	<div class="text"></div>
</div>

	<div id="popup-support" class="popup">
	<h3>Support</h3>
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-support"></a>
	...
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-login"></a>
	...
	<form action="/auth/login"
		...
		<div>
			Unable to sign in?
			<a href="happy-birthday-instagress.html#" class="link-ajax"
	...
	<h3>Sign in Help</h3>
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-login-help"></a>
	<div class="mb20">
		<p>
	...
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-reauth"></a>
	<div class="alerts">
		<div class="alert alert-danger alert-error"></div>
		<div class="alert alert-success"></div>
	</div>
	<form action="/auth/login?mode=reauth&next=/blog/happy-birthday-instagress"
		...
		<div>
			<a href="happy-birthday-instagress.html#" class="link-ajax" data-popup-open="#popup-login-help">Sign in help</a>
		</div>
	</form>
</div>
	...
	<h3>Sign up</h3>
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-account-signup"></a>
...
<div class="dividing-line dividing-line-popup">
	...
	<h3>Log in</h3>
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-account-login"></a>
	<div class="alerts">
		<div class="alert alert-danger alert-error"></div>
		<div class="alert alert-success"></div>
	</div>
...
<div class="dividing-line dividing-line-popup">
	...
	<span>or</span>
		...
		<div class="mb10">
			<a href="happy-birthday-instagress.html#" class="link-ajax" data-popup-open="#popup-account-password-reset">Password reset</a>
		</div>
		<div>
	...
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-account-password-reset"></a>
	<div class="color-gray mb20">
	...
	<a href="happy-birthday-instagress.html#" class="btn-close-x" data-popup-close="#popup-account-required"></a>
	<p>
